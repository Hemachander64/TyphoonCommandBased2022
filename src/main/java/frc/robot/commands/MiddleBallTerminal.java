...
public class MiddleBallTerminal extends SequentialCommandGroup {

    public MiddleBallTerminal(Limelight ll, Shooter shooter, Hood hood, Feeder feeder, Intake intake, Drivetrain dt) {
        ...
        addCommands
        (
            new MiddleBallAuto(ll, shooter, hood, feeder, intake, dt),
